...
errHandler: 'Add ErrHandler 2023/08/18
    Call Print_Error_Message(Error_Info, "VBT_LIB_MBIST", "Protect_Mbist_Sheet") 'Add ErrHandler 2023/08/18
...
Exit Function 'Add ErrHandler 2023/08/18
errHandler: 'Add ErrHandler 2023/08/18
    Call Print_Error_Message(Error_Info, "VBT_LIB_MBIST", "UnProtect_Mbist_Sheet") 'Add ErrHandler 2023/08/18
    If AbortTest Then Exit Function Else Resume Next 'Add ErrHandler 2023/08/18
End Function
...
On Error GoTo errHandler 'Add ErrHandler 2023/08/18
    ...
    Else
        type_nu = -1
        Call Print_Error_Message(Error_Warning_Info.Warning_Info, "VBT_LIB_MBIST", "auto_Mbist_SetLoopCNT_BM", "bistType not CPU or SOC")
    End If
...
Exit Function 'Add ErrHandler 2023/08/18
errHandler: 'Add ErrHandler 2023/08/18
    Call Print_Error_Message(Error_Info, "VBT_LIB_MBIST", "auto_Mbist_SetLoopCNT_BM") 'Add ErrHandler 2023/08/18
    If AbortTest Then Exit Function Else Resume Next 'Add ErrHandler 2023/08/18
End Function
...
'                Next pat
    ...
    Exit Function
errHandler: 'Add ErrHandler 2023/08/18
    Call Print_Error_Message(Error_Info, "VBT_LIB_MBIST", "Mbist_Initialize") 'Add ErrHandler 2023/08/18
    If AbortTest Then Exit Function Else Resume Next 'Add ErrHandler 2023/08/18
End Function
...
'''    ReDim block_type_pat(50, 50, 50)
    ...
    If (bistType = "CPU") Or (bistType = "SOC") Then
        ...
        If (find_AllHeader) Then
            ...
            Do While (m <= idx_END)
                ...
                Case idx_Instance_BM_Decision_column
                    ReDim instance_name(m_lastNCnt - 1)    'redim and hold orignal data
                ...
                Case idx_BM_Pattern_column
                    ReDim instance_flag(m_lastNCnt - 1)
                    ReDim ins_true_name(m_lastNCnt - 1)
                    Do While (n < m_lastNCnt)
                        Set myCell = myCell.Offset(rowOffset:=1, columnOffset:=0)
                        m_cellStr = UCase(Trim(myCell.Value))
                ...
                Case idx_Block_Name_column
                    BlockCounter = 0
                    ReDim block_name(m_lastNCnt - 1)
                    ReDim block_name_count(m_lastNCnt - 1)
                    ReDim block_count_name(m_lastNCnt - 1, m_lastNCnt - 1)
                    Do While (n < m_lastNCnt)
                ...
                Case idx_Pattern_Block_column
                    ...
                    ReDim pattern_name(m_lastNCnt - 1)
                    Do While (n < m_lastNCnt)
                        Set myCell = myCell.Offset(rowOffset:=1, columnOffset:=0)
                        m_cellStr = UCase(Trim(myCell.Value))
                ...
                Case idx_BinFlag_Decision_column
                    ReDim inst_group_name(m_lastNCnt - 1)
                    Do While (n < m_lastNCnt)
                        Set myCell = myCell.Offset(rowOffset:=1, columnOffset:=0)
                        m_cellStr = UCase(Trim(myCell.Value))
                ...
                Case idx_Name_for_BinFlag_column
                    ReDim flag_match_name(m_lastNCnt - 1)
                    Do While (n < m_lastNCnt)
                        Set myCell = myCell.Offset(rowOffset:=1, columnOffset:=0)
                        m_cellStr = UCase(Trim(myCell.Value))
                ...
                Case idx_BinFlag_Mid_Name_column
                    ReDim Preserve flag_mid_name(m_lastNCnt - 1)
                    Do While (n < m_lastNCnt)
                        Set myCell = myCell.Offset(rowOffset:=1, columnOffset:=0)
                        m_cellStr = UCase(Trim(myCell.Value))
...
'        End If
    ...
    Else
        Call Print_Error_Message(Warning_Info, "VBT_LIB_MBIST", "init_MBIST_ChkList_block_loop", "bistType = " & bistType & " not define!!")
    End If

Exit Function 'Add ErrHandler 2023/08/18
errHandler: 'Add ErrHandler 2023/08/18
    Call Print_Error_Message(Error_Info, "VBT_LIB_MBIST", "init_MBIST_ChkList_block_loop") 'Add ErrHandler 2023/08/18
    If AbortTest Then Exit Function Else Resume Next 'Add ErrHandler 2023/08/18
End Function
...
Exit Function 'Add ErrHandler 2023/08/18
errHandler: 'Add ErrHandler 2023/08/18
    Call Print_Error_Message(Error_Info, "VBT_LIB_MBIST", "Separate_nu_char") 'Add ErrHandler 2023/08/18
    If AbortTest Then Exit Function Else Resume Next 'Add ErrHandler 2023/08/18
End Function
