...
{
    [TestClass]
    public class BinCutInstanceTmpsTests : BinCutTestBase
    {
        [TestInitialize]
        public override void Setup()
        {
            ...
            Instance = new BinCutInstanceTmps(FinalRow, SourceRow, BinCutInputData);
        }
        ...
        {
            string subName = "BinCutInstanceTmps_SetVbtArg";
            var instanceRow = new InstanceRow
            {
                TestName = "TestInstance",
                DcSelector = "NV"
        ...
        {
            string subName = "BinCutInstanceTmpsTests_GenerateInstance";
