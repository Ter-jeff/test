...
{
    [TestClass]
    public class BinCutInstanceIlbTests : BinCutTestBase
    {
        [TestInitialize]
        public override void Setup()
        {
            ...
            Instance = new BinCutInstanceIlb(FinalRow, SourceRow, BinCutInputData);
        }
        ...
        {
            string subName = "BinCutInstanceIlb_SetVbtArg";
            var instanceRow = new InstanceRow
            {
                TestName = "TestInstance",
                DcSelector = "NV"
        ...
        {
            string subName = "BinCutInstanceIlbTests_GenerateInstance";
