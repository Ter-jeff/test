...
'''20230406 Request from MT create a new format about multifstp
...
Public Flag_SyncUp_DCVS_Output_enable As Boolean                       'Added to control SyncUp_DCVS_Output. '20240227
...
Public Const Flag_noRestoreVoltageForPrepatt = True '20230728 Due to all project bincut have VALT so always turn on it.
'Control vbt not to save and restore Payload voltages for Prepatt (only for projects with rail-switch).
...
Public Const VddbinIDSFailSortNumber = 9801                             'SortNumber of Flag_Vddbinning_IDS_fail.
Public Const VddbinIDSFailBinNumber = 11                                'BinNumber of Flag_Vddbinning_IDS_fail.
Public Const VddbinFailStopSortNumber = 9802                            'SortNumber of Flag_Vddbinning_Fail_Stop.
Public Const VddbinFailStopBinNumber = 11                               'BinNumber of Flag_Vddbinning_Fail_Stop & Flag_Vddbinning_IDS_fail.
'=======================================================================================================
' variable
'=======================================================================================================
...
Public Type Instance_Info
    ...
    BeSSNTest As Boolean '240703
    Harv_CommonFailFlag As String
End Type
...
Public Syncup_Dict As New Dictionary '20240227
Public Syncup_Dict_boolean As Boolean
