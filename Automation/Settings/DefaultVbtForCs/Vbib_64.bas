...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'   NI-488.2 DLL entry function declarations for 64bit application
'   v1.0    2020/01/21  Pavan Ramakrishna/Ind/Teradyne  converted from Vbib_32 to Vbib_64


Declare PtrSafe Function ibask32 Lib "ni4882.dll" Alias "ibask" (ByVal ud As Long, ByVal opt As Long, value As Long) As Long
Declare PtrSafe Function ibbna32 Lib "ni4882.dll" Alias "ibbnaA" (ByVal ud As Long, sstr As Any) As Long
Declare PtrSafe Function ibcac32 Lib "ni4882.dll" Alias "ibcac" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibclr32 Lib "ni4882.dll" Alias "ibclr" (ByVal ud As Long) As Long
Declare PtrSafe Function ibcmd32 Lib "ni4882.dll" Alias "ibcmd" (ByVal ud As Long, sstr As Any, ByVal cnt As Long) As Long
Declare PtrSafe Function ibcmda32 Lib "ni4882.dll" Alias "ibcmda" (ByVal ud As Long, sstr As Any, ByVal cnt As Long) As Long
Declare PtrSafe Function ibconfig32 Lib "ni4882.dll" Alias "ibconfig" (ByVal ud As Long, ByVal opt As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibdev32 Lib "ni4882.dll" Alias "ibdev" (ByVal bdid As Long, ByVal pad As Long, ByVal sad As Long, ByVal tmo As Long, ByVal eot As Long, ByVal eos As Long) As Long
Declare PtrSafe Function ibdma32 Lib "ni4882.dll" Alias "ibdma" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibeos32 Lib "ni4882.dll" Alias "ibeos" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibeot32 Lib "ni4882.dll" Alias "ibeot" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibfind32 Lib "ni4882.dll" Alias "ibfindA" (sstr As Any) As Long
Declare PtrSafe Function ibgts32 Lib "ni4882.dll" Alias "ibgts" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibist32 Lib "ni4882.dll" Alias "ibist" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function iblck32 Lib "ni4882.dll" Alias "iblck" (ByVal ud As Long, ByVal v As Long, ByVal LockWaitTime As Long, Arg1 As Any) As Long
Declare PtrSafe Function iblines32 Lib "ni4882.dll" Alias "iblines" (ByVal ud As Long, v As Long) As Long
Declare PtrSafe Function ibln32 Lib "ni4882.dll" Alias "ibln" (ByVal ud As Long, ByVal pad As Long, ByVal sad As Long, ln As Long) As Long
Declare PtrSafe Function ibloc32 Lib "ni4882.dll" Alias "ibloc" (ByVal ud As Long) As Long
Declare PtrSafe Function iblock32 Lib "ni4882.dll" Alias "iblock" (ByVal ud As Long) As Long
Declare PtrSafe Function ibonl32 Lib "ni4882.dll" Alias "ibonl" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibpad32 Lib "ni4882.dll" Alias "ibpad" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibpct32 Lib "ni4882.dll" Alias "ibpct" (ByVal ud As Long) As Long
Declare PtrSafe Function ibppc32 Lib "ni4882.dll" Alias "ibppc" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibrd32 Lib "ni4882.dll" Alias "ibrd" (ByVal ud As Long, sstr As Any, ByVal cnt As Long) As Long
Declare PtrSafe Function ibrda32 Lib "ni4882.dll" Alias "ibrda" (ByVal ud As Long, sstr As Any, ByVal cnt As Long) As Long
Declare PtrSafe Function ibrdf32 Lib "ni4882.dll" Alias "ibrdfA" (ByVal ud As Long, sstr As Any) As Long
Declare PtrSafe Function ibrpp32 Lib "ni4882.dll" Alias "ibrpp" (ByVal ud As Long, sstr As Any) As Long
Declare PtrSafe Function ibrsc32 Lib "ni4882.dll" Alias "ibrsc" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibrsp32 Lib "ni4882.dll" Alias "ibrsp" (ByVal ud As Long, sstr As Any) As Long
Declare PtrSafe Function ibrsv32 Lib "ni4882.dll" Alias "ibrsv" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibsad32 Lib "ni4882.dll" Alias "ibsad" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibsic32 Lib "ni4882.dll" Alias "ibsic" (ByVal ud As Long) As Long
Declare PtrSafe Function ibsre32 Lib "ni4882.dll" Alias "ibsre" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibstop32 Lib "ni4882.dll" Alias "ibstop" (ByVal ud As Long) As Long
Declare PtrSafe Function ibtmo32 Lib "ni4882.dll" Alias "ibtmo" (ByVal ud As Long, ByVal v As Long) As Long
Declare PtrSafe Function ibtrg32 Lib "ni4882.dll" Alias "ibtrg" (ByVal ud As Long) As Long
Declare PtrSafe Function ibunlock32 Lib "ni4882.dll" Alias "ibunlock" (ByVal ud As Long) As Long
Declare PtrSafe Function ibwait32 Lib "ni4882.dll" Alias "ibwait" (ByVal ud As Long, ByVal mask As Long) As Long
Declare PtrSafe Function ibwrt32 Lib "ni4882.dll" Alias "ibwrt" (ByVal ud As Long, sstr As Any, ByVal cnt As Long) As Long
Declare PtrSafe Function ibwrta32 Lib "ni4882.dll" Alias "ibwrta" (ByVal ud As Long, sstr As Any, ByVal cnt As Long) As Long
Declare PtrSafe Function ibwrtf32 Lib "ni4882.dll" Alias "ibwrtfA" (ByVal ud As Long, sstr As Any) As Long
Declare PtrSafe Sub AllSpoll32 Lib "ni4882.dll" Alias "AllSpoll" (ByVal boardID As Long, Arg1 As Any, Arg2 As Any)
Declare PtrSafe Sub DevClear32 Lib "ni4882.dll" Alias "DevClear" (ByVal boardID As Long, ByVal v As Long)
Declare PtrSafe Sub DevClearList32 Lib "ni4882.dll" Alias "DevClearList" (ByVal boardID As Long, Arg1 As Any)
Declare PtrSafe Sub EnableLocal32 Lib "ni4882.dll" Alias "EnableLocal" (ByVal boardID As Long, Arg1 As Any)
Declare PtrSafe Sub EnableRemote32 Lib "ni4882.dll" Alias "EnableRemote" (ByVal boardID As Long, Arg1 As Any)
Declare PtrSafe Sub FindLstn32 Lib "ni4882.dll" Alias "FindLstn" (ByVal boardID As Long, Arg1 As Any, Arg2 As Any, ByVal limit As Long)
Declare PtrSafe Sub FindRQS32 Lib "ni4882.dll" Alias "FindRQS" (ByVal boardID As Long, Arg1 As Any, result As Long)
Declare PtrSafe Sub PassControl32 Lib "ni4882.dll" Alias "PassControl" (ByVal boardID As Long, ByVal addr As Long)
Declare PtrSafe Sub PPoll32 Lib "ni4882.dll" Alias "PPoll" (ByVal boardID As Long, result As Long)
Declare PtrSafe Sub PPollConfig32 Lib "ni4882.dll" Alias "PPollConfig" (ByVal boardID As Long, ByVal addr As Long, ByVal line As Long, ByVal sense As Long)
Declare PtrSafe Sub PPollUnconfig32 Lib "ni4882.dll" Alias "PPollUnconfig" (ByVal boardID As Long, Arg1 As Any)
Declare PtrSafe Sub RcvRespMsg32 Lib "ni4882.dll" Alias "RcvRespMsg" (ByVal boardID As Long, Arg1 As Any, ByVal cnt As Long, ByVal term As Long)
Declare PtrSafe Sub ReadStatusByte32 Lib "ni4882.dll" Alias "ReadStatusByte" (ByVal boardID As Long, ByVal addr As Long, result As Long)
Declare PtrSafe Sub Receive32 Lib "ni4882.dll" Alias "Receive" (ByVal boardID As Long, ByVal addr As Long, Arg1 As Any, ByVal cnt As Long, ByVal term As Long)
Declare PtrSafe Sub ReceiveSetup32 Lib "ni4882.dll" Alias "ReceiveSetup" (ByVal boardID As Long, ByVal addr As Long)
Declare PtrSafe Sub ResetSys32 Lib "ni4882.dll" Alias "ResetSys" (ByVal boardID As Long, Arg1 As Any)
Declare PtrSafe Sub Send32 Lib "ni4882.dll" Alias "Send" (ByVal boardID As Long, ByVal addr As Long, sstr As Any, ByVal cnt As Long, ByVal term As Long)
Declare PtrSafe Sub SendCmds32 Lib "ni4882.dll" Alias "SendCmds" (ByVal boardID As Long, sstr As Any, ByVal cnt As Long)
Declare PtrSafe Sub SendDataBytes32 Lib "ni4882.dll" Alias "SendDataBytes" (ByVal boardID As Long, sstr As Any, ByVal cnt As Long, ByVal term As Long)
Declare PtrSafe Sub SendIFC32 Lib "ni4882.dll" Alias "SendIFC" (ByVal boardID As Long)
Declare PtrSafe Sub SendList32 Lib "ni4882.dll" Alias "SendList" (ByVal boardID As Long, Arg1 As Any, Arg2 As Any, ByVal cnt As Long, ByVal term As Long)
Declare PtrSafe Sub SendLLO32 Lib "ni4882.dll" Alias "SendLLO" (ByVal boardID As Long)
Declare PtrSafe Sub SendSetup32 Lib "ni4882.dll" Alias "SendSetup" (ByVal boardID As Long, Arg1 As Any)
Declare PtrSafe Sub SetRWLS32 Lib "ni4882.dll" Alias "SetRWLS" (ByVal boardID As Long, Arg1 As Any)
Declare PtrSafe Sub TestSys32 Lib "ni4882.dll" Alias "TestSys" (ByVal boardID As Long, Arg1 As Any, Arg2 As Any)
Declare PtrSafe Sub Trigger32 Lib "ni4882.dll" Alias "Trigger" (ByVal boardID As Long, ByVal addr As Long)
Declare PtrSafe Sub TriggerList32 Lib "ni4882.dll" Alias "TriggerList" (ByVal boardID As Long, Arg1 As Any)

'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'   DLL entry function declarations needed for GPIB global variables

Declare PtrSafe Function RegisterGpibGlobalsForThread Lib "ni4882.dll" (Longibsta As Long, Longiberr As Long, Longibcnt As Long, ibcntl As Long) As Long
Declare PtrSafe Function UnregisterGpibGlobalsForThread Lib "ni4882.dll" () As Long
Declare PtrSafe Function Ibsta32 Lib "ni4882.dll" Alias "Ibsta" () As Long ' new additions  ' 2020/01/21
Declare PtrSafe Function Iberr32 Lib "ni4882.dll" Alias "Iberr" () As Long ' new additions  ' 2020/01/21
Declare PtrSafe Function Ibcnt32 Lib "ni4882.dll" Alias "Ibcnt" () As Long ' new additions  ' 2020/01/21
Declare PtrSafe Function ThreadIbsta32 Lib "ni4882.dll" Alias "ThreadIbsta" () As Long
Declare PtrSafe Function ThreadIbcnt32 Lib "ni4882.dll" Alias "ThreadIbcnt" () As Long
Declare PtrSafe Function ThreadIbcntl32 Lib "ni4882.dll" Alias "ThreadIbcntl" () As Long
Declare PtrSafe Function ThreadIberr32 Lib "ni4882.dll" Alias "ThreadIberr" () As Long
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Declare PtrSafe Function iblockx32 Lib "ni4882.dll" Alias "iblockxA" (ByVal ud As Long, ByVal LockWaitTime As Long, Arg1 As Any) As Long
Declare PtrSafe Function ibunlockx32 Lib "ni4882.dll" Alias "ibunlockx" (ByVal ud As Long) As Long
...
Public Sub RegisterGPIBGlobals()
    ...
    ibsta = ConvertLongToInt(Ibsta32()) ' new additions
    ibcnt = ConvertLongToInt(Ibcnt32()) ' new additions
    iberr = ConvertLongToInt(Iberr32()) ' new additions
    ibcntl = ibcnt
    'iberr
'    If (rc = 0) Then
