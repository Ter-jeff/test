...
namespace Automation.GenerateIgxl.Wireless.DVDC.InstanceParameterSetting
{
    ...
    public class SetRfHtolFuncValue : SetValueBase
    {
        ...
        public SetRfHtolFuncValue(HardIpInputData hardIpInputData, HardIpSheet hardIpSheet) : base(hardIpInputData, hardIpSheet)
        {
        }
