...
namespace CommonLib.Utility
{
    ...
    public class FileData
    {
        ...
        internal FileData(string dir, WIN32_FIND_DATA findData)
        {
            ...
            CreationTimeUtc = ConvertDateTime(findData.FtCreationTimeDwHighDateTime,
                                                findData.FtCreationTimeDwLowDateTime);

            LastAccessTimeUtc = ConvertDateTime(findData.FtLastAccessTimeDwHighDateTime,
                                                findData.FtLastAccessTimeDwLowDateTime);

            LastWriteTimeUtc = ConvertDateTime(findData.FtLastWriteTimeDwHighDateTime,
                                                findData.FtLastWriteTimeDwLowDateTime);
    ...
    internal class WIN32_FIND_DATA
    {
        ...
        public uint FtCreationTimeDwLowDateTime;
        public uint FtCreationTimeDwHighDateTime;
        public uint FtLastAccessTimeDwLowDateTime;
        public uint FtLastAccessTimeDwHighDateTime;
        public uint FtLastWriteTimeDwLowDateTime;
        public uint FtLastWriteTimeDwHighDateTime;
    ...
    public static class FastDirectoryEnumerator
    {
        ...
        private class FileEnumerator : IEnumerator<FileData>
        {
            ...
            private WIN32_FIND_DATA _winFindData = new WIN32_FIND_DATA();
            ...
            {
                get { return new FileData(_path, _winFindData); }
            }
            ...
            public bool MoveNext()
            {
                ...
                else if (_searchOption == SearchOption.AllDirectories)
                {
                    ...
                    //_path = Path.Combine(_path, _winFindData.CFileName);
                    //_hndFindFile = null;
