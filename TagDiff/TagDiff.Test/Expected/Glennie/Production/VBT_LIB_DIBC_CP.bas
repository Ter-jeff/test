Attribute VB_Name = "VBT_LIB_DIBC_CP"
Option Explicit

' const
Public Const DIBC_FOLDER = "dibc_glennie_cp"
...
Private Sub Test_Pin_Site_Channel_Dict()
    Debug.Assert Util_Get_Channel("REFCLK", 0) <> "-1"
...
Private Function CP_DIBC_Lib_MeasureIOleakage(tNum As String, argarray As Variant) As PinListData
...
'Ben Modify 20220303
Private Sub CP_DIBC_Lib_UtilityCheck(tNum As String, argarray As Variant)
...
'Cory Modify 20220307
        ...
        For i = 0 To UBound(arrAllRelayPins)
                ...
                If (i + 1) Mod 20 = 0 Or i = UBound(arrAllRelayPins) Then
                        ...
                        lowVal:=1, hiVal:=1)
                        Util_Judge_Result pldMeasureValue, 4100 + 10, "UDBCHECK_OFF", ""
                        If TheExec.sites.ActiveCount = 0 Then Exit Sub
...
Private Sub CP_DIBC_Lib_SPI_ROM(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UP1600_IO(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UP1600_R(tNum As String, argarray As Variant)
End Sub
Private Sub CP_DIBC_Lib_UP1600_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UP1600_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UP1600_RELAY_R_2(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UP1600_RELAY_2(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UVI80_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UVI80_RELAY_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub CP_DIBC_Lib_UVI80_Relay_C_2(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UVI80_RELAY_C_3(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_UVI80_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
    ...
    Call Relay_Circuit_check(tNum, 0.05, 0.004, 1.7, 2.3, Join(Array(k2, k3), ","), 0.003, p1, "")
...
Private Sub CP_DIBC_Lib_UVS256_RELAY_C_3(tNum As String, argarray As Variant)
On Error GoTo errHandler
    'argArray = Array("PAD_MTR_VREF_P","PAD_MTR_VREF_N","K13","K12","1.00e-06")
...
Private Sub CP_DIBC_Lib_UVS256_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub CP_DIBC_Lib_UVS256_RELAY_UP1600(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub CP_DIBC_Lib_HEXVS_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_COMPLEX(tNum As String, argarray As Variant)
On Error GoTo errHandler
'argArray = Array("VDDQL_DDR", "DDR0_RREF", "K31", "DDR1_RREF", "K32", "DDR2_RREF", "K33", "DDR3_RREF", "K34")
    Dim k1 As String
    Dim k2 As String
...
End Sub
Private Sub CP_DIBC_Lib_DIFF_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_FRC_BUFFER(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim PortName  As String: PortName = "REFCLK_Port"
    Dim DUTPin    As String: DUTPin = "REFCLK_PA"
    Dim Bufferpin As String: Bufferpin = "REFCLK_REFCLK"

    ' clock Fan-out Buffer
    Call FreeRunClk_Disable_dibchecker("REFCLK_Port") 'disable clock
    ...
    Call MeasFreq_dibchecker(tNum, Bufferpin, 0.001, "REFCLK_REFCLK")

    Call FreeRunclk_Enable_dibchecker(tNum + 10, PortName, DUTPin, Bufferpin, "REFCLK_REFCLK_PLLLock")
...
Private Sub CP_DIBC_Lib_LOOP_BACK(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_SB_EEPROM(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub CP_DIBC_Lib_SB_Power(tNum As String, argarray As Variant)
On Error GoTo errHandler
    'header
...
Private Sub CP_DIBC_Lib_UP2200_IO(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub CP_DIBC_Lib_TmpSensor(tNum As String, argarray As Variant)
End Sub
'Ben Modify 230605
Private Sub CP_DIBC_Lib_UVI80_RES_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim Relay_On As String
    Dim Test_PinName As String
...
Private Sub CP_DIBC_Lib_UVS64_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
    ' argArray =  Array("VDD12_ADC:4.15e-05","VDD12_AMUX:3.92e-05", ...)
    Dim tokens() As String
    Dim i        As Integer
...
End Sub
Private Sub CP_DIBC_Lib_UVS256HP_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
 ' argArray =  Array("VDD12_ADC:4.15e-05","VDD12_AMUX:3.92e-05", ...)
    Dim tokens() As String
    Dim i        As Integer
...
End Sub
Private Sub CP_DIBC_Lib_UVS256HP_R(tNum As String, argarray As Variant)
End Sub
Private Sub CP_DIBC_Lib_UP2200_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim Relay_On As String
    Dim Route_Start As String
    Dim Route_End As String
...
End Sub
Private Sub CP_DIBC_Lib_COMPLEX_PLUS(tNum As String, argarray As Variant)
On Error GoTo errHandler
  'argArray = Array("VDDQL_DDR", "DDR0_RREF", "K31", "DDR1_RREF", "K32", "DDR2_RREF", "K33", "DDR3_RREF", "K34")
    ' Dim powerPin As String: powerPin = argArray(0)
    ' Dim p1       As String
...
End Sub
Private Sub CP_DIBC_Lib_UVS256HP_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
'argArray = Array("PAD_MTR_ANALOG_TEST_N","K10","1.20e-06")
    Dim Relay_On As String
    Dim Test_PinName As String
...
Private Sub CP_DIBC_Lib_UVS256_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
'argArray = Array("PAD_MTR_ANALOG_TEST_N","K10","1.20e-06")
    Dim Relay_On As String
    Dim Test_PinName As String
...
Private Sub CP_DIBC_Lib_Uvi80_C_Cap(tNum As String, argarray As Variant)
...
Private Sub CP_DIBC_Lib_UP2200_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
' argArray = Array("ATC1_USB_RESREF","K32","K33")
    Dim p1 As String: p1 = argarray(0)
    Dim k1 As String: k1 = argarray(1)
...
Private Sub CP_DIBC_Lib_UP2200_RELAY_C_3(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim p1 As String: p1 = argarray(0)
    Dim p2 As String: p2 = argarray(1)
    Dim k1 As String: k1 = argarray(2)
...
Private Sub CP_DIBC_Lib_UP2200_RELAY_C_4(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim p1 As String: p1 = argarray(0)
    Dim p2 As String: p2 = argarray(1)
    Dim k1 As String: k1 = argarray(2)
...
Private Sub CP_DIBC_Lib_UP2200_RELAY_R2(tNum As String, argarray As Variant)
On Error GoTo errHandler
     ' argArray = Array("RT_CLK32768","RT_CLK32768_PA","K01")
...
End Sub
Private Sub CP_DIBC_Lib_UVS256HP_RELAY_R1(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim Relay_On As String
    Dim Route_Start As String
    Dim Route_End As String
...
On Error GoTo errHandler
    ...
    Call TheHdw.Digital.pins("QSPI0_DQ0").patterns(spiRomPat).ModifyVectorBlockData("", 4, pat_modify)
    TheHdw.Wait 0.05

    TheHdw.patterns(spiRomPat).start
    TheHdw.Digital.Patgen.HaltWait
    numcap = 8
    PinData = TheHdw.Digital.pins("QSPI0_DQ1").hram.PinPF(0, , numcap)
    ...
    Dim pldMeasureValue As New PinListData: pldMeasureValue.AddPin "QSPI0_DQ1"
    ...
    If data = &H5 Then
        pldMeasureValue.pins("QSPI0_DQ1") = sdbRegValue1
...
On Error GoTo errHandler
    ...
    Call TheHdw.Digital.pins("QSPI0_DQ0").patterns(spiRomDebugPat).ModifyVectorBlockData("", 4, pat_modify)
    TheHdw.Wait 0.05
    ...
    pldMeasureValue.pins("QSPI0_DQ1") = sdbRegValue2
    ...
    pldMeasureValue.pins("QSPI0_DQ1") = sdbRegValue3
...
'    On Error GoTo errHandler
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, LoadLevels:=True, LoadTiming:=True, RelayMode:=tlPowered, PinLevelsSheet:="DIBC_TSets__CP", TimeSetSheet:="DIBC_Levels__CP" ''May2 added
        '''0831 by rita
...
On Error GoTo errHandler
    ...
    RStep = 20
    RStep_2 = 100
        If (pinname_str = "SPI1_SSIN") Or (pinname_str = "SPI1_SCLK") Or (pinname_str = "QSPI0_DQ1") Or (pinname_str = "QSPI0_DQ0") Then
    ...
    If (pinname_str = "LP_CLK") Or (pinname_str = "REFCLK") Or (pinname_str = "MADI_TXCLK_IN") Or (pinname_str = "SWD_TCK_OUT") Then
...
On Error GoTo errHandler
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, LoadLevels:=True, LoadTiming:=True, RelayMode:=tlPowered, PinLevelsSheet:="DIBC_Levels__CP", TimeSetSheet:="DIBC_TSets__CP"
     ...
     End If
                ...
                If LCase(TheExec.DataManager.pinType(Route_End)) = "power" Then
                        ...
                        '***-----------------------***'
                                    With TheHdw.DCVS.pins(Route_End)
                                       ...
                                       If LCase(GetInstrument_PWR_Pin(CStr(Route_End), 0)) = "vs-800ma" Then
                                            .CurrentRange = 0.002
                                       Else
          ...
          If LCase(TheExec.DataManager.ChannelType(Route_Start)) = "i/o" Then
           ...
           ElseIf LCase(TheExec.DataManager.ChannelType(Route_Start)) = "dcvi" Then
                ...
                R_Value = R_Value.Math.divide(Current_Range)
                Util_Judge_Result R_Value, tNum, "Relay On Resistance", "Ohm"
                tNum = CStr(CLng(tNum) + 1)
                'TheExec.Flow.TestLimit resultVal:=R_Value, lowVal:=R_LowLimit, hiVal:=R_HiLimit, unit:=unitCustom, scaletype:=scaleNone, formatStr:="%.3f", Tname:=Tname, forceVal:=Force_volt, ForceUnit:=unitVolt, customUnit:="ohm", ForceResults:=tlForceNone
...
'    On Error GoTo 0
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, RelayMode:=tlPowered, LoadLevels:=True, LoadTiming:=True, _
                                     PinLevelsSheet:="DIBC_Levels__CP", TimeSetSheet:="DIBC_TSets__CP"
...
On Error GoTo errHandler
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, LoadLevels:=True, LoadTiming:=True, RelayMode:=tlPowered, PinLevelsSheet:="DIBC_Levels__CP", TimeSetSheet:="DIBC_TSets__CP"  '0831 by rita 'DIBC_TSets__
    TheHdw.Wait 0.01
...
Private Sub CP_DIBC_Test_4000()
    CP_DIBC_Lib_MeasureIOleakage 4000, Array()
End Sub

Private Sub CP_DIBC_Test_4100()
    CP_DIBC_Lib_UtilityCheck 4100, Array()
End Sub

Private Sub CP_DIBC_Test_5000()
    CP_DIBC_Lib_SPI_ROM 5000, Array("K110", "K111", "K58", "K59", "K60", "K61")
End Sub

Private Sub CP_DIBC_Test_10000()
    CP_DIBC_Lib_UP1600_IO 10000, Array("AON_I2C_SCL", "AON_I2C_SCM_CS_TRIG0", "AON_I2C_SCM_CS_TRIG1", "AON_I2C_SCM_CS_TRIG2", "AON_I2C_SDA", "AON_MCA_BCLK", "AON_MCA_DIN", "AON_MCA_DOUT", "AON_MCA_LRCK", "AON_SPI_CK", "AON_SPI_CSN", "AON_SPI_MISO", "AON_SPI_MOSI", "AON_SPI_SCM_CS_TRIG0", "AON_SPI_SCM_CS_TRIG1", "AON_SPI_SCM_CS_TRIG2", "AON_SPI_SCM_CS_TRIG3", "AON_SPMI0_SCL", "AON_SPMI0_SDA", "AON_SPMI1_SCL", "AON_SPMI1_SDA", "AON_UART_RXD", "AON_UART_TXD", "AP_LOCK_REMOTE", "AUD_MCA_BCLK", "AUD_MCA_DIN", "AUD_MCA_DOUT", "AUD_MCA_LRCK", "AUD_MCA_MCLK", "AUD_SPK_MCA_BCLK", "AUD_SPK_MCA_DIN", "AUD_SPK_MCA_DOUT", _
"AUD_SPK_MCA_LRCK", "BOARD_ID0", "BOARD_ID1", "BOARD_ID2", "BOOT_MODE", "BTMAC_FREE_RUNNING_CLK", "BTMAC_LRS_LOAD", "BT_GPIO0", "BT_GPIO1", "CFSB_LDO0", "CFSB_LDO1", "DBG_PROBE_VALID", "DFU_STATUS", "DOCK_CONNECT", "EXT_RESET_N", "FAST_BOOT", "FORCE_DFU", "GA_TSYNC", "HEB_SPMI_SCLK", "HEB_SPMI_SDAT", "HG_TSYNC", "I2C0_SCL", "I2C0_SDA", "I2C1_SCL", "I2C1_SDA", "ICF_DHCLK", "ICF_DHDATA0", "ICF_DHDATA1", "ICF_DHDATA2", "ICF_DHDATA3", "ICF_DH_WAKEUP", "ICF_HDCLK", "ICF_HDDATA0", "ICF_HDDATA1", "ICF_HDDATA2", "ICF_HDDATA3", "ICF_HD_WAKEUP", "INSECURE_MODE", "JTAG_SEL", "JTAG_TCK", "JTAG_TDI", _
"JTAG_TDO", "JTAG_TMS", "JTAG_TRSTN", "KIS_DFU_SELECT", "KIS_TO_PMU_REQUEST_DFU", "KIS_TO_PMU_RESET", "LP_CLK_AON", "MADI_IO0", "MADI_TX0", "MADI_TX1", "MADI_TX2", "MADI_TX3", "MADI_TX4", "PDM0_CLK", "PDM1_CLK", "PDM2_CLK", "PDM3_CLK", "PDM4_CLK", "PDM5_CLK", "PDM_IN0_DATA", "PDM_IN1_DATA", "PDM_IN2_DATA", "PDM_IN3_DATA", "PROD_MODE_SHAD_REMOTE", "QSPI0_CSN1", "QSPI_F_CK", "QSPI_F_CSN", "QSPI_F_EXT_IRQ", "QSPI_F_IO0", "QSPI_F_IO1", "QSPI_F_IO2", "QSPI_F_IO3", "REFCLK_1V2", "REFCLK_SEL", "REFCLK_VALID", "RTP_I2C0_SCL", "RTP_I2C0_SCM_CS_TRIG0", "RTP_I2C0_SCM_CS_TRIG1", "RTP_I2C0_SCM_CS_TRIG2", _
"RTP_I2C0_SDA", "RTP_I2C1_SCM_CS_TRIG0", "RTP_I2C1_SCM_CS_TRIG1", "RTP_I2C1_SCM_CS_TRIG2", "RTP_I2C2_SCM_CS_TRIG0", "RTP_I2C2_SCM_CS_TRIG1", "RTP_I2C2_SCM_CS_TRIG2", "RTP_SPI0_CK", "RTP_SPI0_CSN", "RTP_SPI0_MISO", "RTP_SPI0_MOSI", "RTP_SPI0_SCM_CS_TRIG0", "RTP_SPI0_SCM_CS_TRIG1", "RTP_SPI0_SCM_CS_TRIG2", "SPARE_GPIO0", "SPARE_GPIO1", "SPI0_CK", "SPI0_CSN", "SPI0_MISO", "SPI0_MOSI", "SWD_TMS0", "SWD_TMS1", "SWD_TMS2", "SWD_TMS3", "SWD_TMS4", "SWD_TMS5", "TESTMODE", "TST_CLKOUT", "UART0_RXD", "UART0_TXD", "UART1_RXD", "UART1_TXD", "UART2_RXD", "UART2_TXD", "UID_MODE_L", "USB_EDM", _
"USB_EDP", "USB_EN", "WDOG")
End Sub

Private Sub CP_DIBC_Test_60000()
    CP_DIBC_Lib_UP1600_RELAY_R_2 60000, Array("MADI_IO1_PA", "K48", "")
End Sub

Private Sub CP_DIBC_Test_60100()
    CP_DIBC_Lib_UP1600_RELAY_R_2 60100, Array("USB_RESREF", "K46", "K47")
End Sub

Private Sub CP_DIBC_Test_70000()
    CP_DIBC_Lib_UP1600_RELAY_2 70000, Array("LP_CLK", "LP_CLK_PA", "SWD_TCK_OUT", "SWD_TCK_OUT_PA", "K70")
End Sub

Private Sub CP_DIBC_Test_70100()
    CP_DIBC_Lib_UP1600_RELAY_2 70100, Array("MADI_TXCLK_IN", "MADI_TXCLK_IN_PA", "REFCLK", "REFCLK_PA", "K71")
End Sub

Private Sub CP_DIBC_Test_200000()
    CP_DIBC_Lib_UVI80_RELAY 200000, Array("ANALOGMUX_OUT_POS", "K78")
End Sub

Private Sub CP_DIBC_Test_400000()
    CP_DIBC_Lib_UVS256_C 400000, Array("VDDA_EFUSE0:6.12e-05", "VDDA_EFUSE1:6.23e-05", "VDDA_EFUSE2:6.17e-05", "VDDIO10_AMUX:2.28e-05", "VDDIO10_ULPPLL_FLPPLL:2.28e-05", "VDDIO12_EUSB:2.28e-05", "VDDIO12_GRP1:1.63e-04", "VDDIO12_GRP2:3.91e-05", "VDDIO12_GRP3:4.65e-05", "VDD_DIG:8.66e-05", "VDD_FIXED_EUSB:6.99e-05", "VDD_FIXED_OSC60M:2.28e-05", "VDD_FIXED_ULPPLL_FLPPLL:2.28e-05", "VDD_SOC:3.85e-05", "VDD_SRAM:6.99e-05")
End Sub

Private Sub CP_DIBC_Test_410000()
    CP_DIBC_Lib_UVS256_RELAY_UP1600 410000, Array("23.VS_F017", "AON_MCA_MCLK", "K112")
End Sub

Private Sub CP_DIBC_Test_620000()
    CP_DIBC_Lib_FRC_BUFFER 620000, Array("NONE")
End Sub

Private Sub CP_DIBC_Test_650000()
    CP_DIBC_Lib_SB_EEPROM 650000, Array("NONE")
End Sub

Private Sub CP_DIBC_Test_660000()
    CP_DIBC_Lib_SB_Power 660000, Array()
End Sub
