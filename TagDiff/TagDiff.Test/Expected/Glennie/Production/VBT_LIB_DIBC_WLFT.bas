Attribute VB_Name = "VBT_LIB_DIBC_WLFT"
Option Explicit

' const
Public Const DIBC_FOLDER = "dibc_thera_wlft"
...
TheHdw.Alarms.Check
    ...
    ' fail stop
    If (Not dibcPassFlag) And failStop Then Call DIBC_Fail_Retry_Or_Abort_WLFT
...
Private Sub DIBC_Fail_Retry_Or_Abort_WLFT()
...
Private Function Util_Get_Dib_Serial() As String
    ...
    With CreateObject("wscript.shell")
        Util_Get_Dib_Serial = .RegRead("HKEY_CURRENT_USER\Software\VB and VBA Program Settings\IEDA\PROBECARD_ID")
    End With
...
Private Function WLFT_DIBC_Lib_MeasureIOleakage(tNum As String, argarray As Variant) As PinListData
...
'Ben Modify 20220303
Private Sub WLFT_DIBC_Lib_UtilityCheck(tNum As String, argarray As Variant)
...
Private Sub WLFT_DIBC_Lib_SPI_ROM(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UP1600_IO(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UP1600_R(tNum As String, argarray As Variant)
End Sub
Private Sub WLFT_DIBC_Lib_UP1600_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UP1600_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Relay_On = argarray(1)
Call Relay_Circuit_check(tNum, 6, 0.004, 1.7, 2.3, Relay_On, 0.003, Route_Start, "")
...
Private Sub WLFT_DIBC_Lib_UP1600_RELAY_R_2(tNum As String, argarray As Variant)
On Error GoTo errHandler
    ...
    Call Relay_Circuit_check(CStr(CLng(tNum) + 20), 6, 0.004, 1.7, 2.3, k1, 0.003, p1, "")
...
Private Sub WLFT_DIBC_Lib_UP1600_RELAY_2(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UVI80_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UVI80_RELAY_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub WLFT_DIBC_Lib_UVI80_Relay_C_2(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UVI80_RELAY_C_3(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UVI80_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_UVS256_RELAY_C_3(tNum As String, argarray As Variant)
On Error GoTo errHandler
    'argArray = Array("PAD_MTR_VREF_P","PAD_MTR_VREF_N","K13","K12","1.00e-06")
...
Private Sub WLFT_DIBC_Lib_UVS256_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub WLFT_DIBC_Lib_UVS256_RELAY_UP1600(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub WLFT_DIBC_Lib_HEXVS_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_COMPLEX(tNum As String, argarray As Variant)
On Error GoTo errHandler
'argArray = Array("VDDQL_DDR", "DDR0_RREF", "K31", "DDR1_RREF", "K32", "DDR2_RREF", "K33", "DDR3_RREF", "K34")
    Dim k1 As String
    Dim k2 As String
    ...
    For i = 1 To SubCKT_Num
        ...
        Component_idx = Component_idx + 1
        Relay_On = K9 & "," & K10
        Call Relay_Circuit_check(tNum, 6, 0.004, 1.7, 2.3, Relay_On, 0.003, Route_Start, Route_End)
        tNum = CStr(CLng(tNum) + 10)
...
End Sub
Private Sub WLFT_DIBC_Lib_DIFF_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
    ...
    Call Relay_Circuit_check(Util_Incr(tNum, 40), 6, 0.004, 1.7, 2.3, Join(Array(k1, k2, k3, k4), ","), 0.003, p1, p2)
...
Private Sub WLFT_DIBC_Lib_FRC_BUFFER(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_LOOP_BACK(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_SB_EEPROM(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
End Sub
Private Sub WLFT_DIBC_Lib_SB_Power(tNum As String, argarray As Variant)
On Error GoTo errHandler
    'header
...
Private Sub WLFT_DIBC_Lib_UP2200_IO(tNum As String, argarray As Variant)
On Error GoTo errHandler
...
Private Sub WLFT_DIBC_Lib_TmpSensor(tNum As String, argarray As Variant)
End Sub
'Ben Modify 230605
Private Sub WLFT_DIBC_Lib_UVI80_RES_RELAY(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim Relay_On As String
    Dim Test_PinName As String
    ...
    Test_PinName = argarray(0)
        ...
        Call Relay_Circuit_check(tNum, 6, 0.004, 1.7, 2.3, Relay_On, 0.003, Test_PinName, "")
...
Private Sub WLFT_DIBC_Lib_UVS64_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
    ' argArray =  Array("VDD12_ADC:4.15e-05","VDD12_AMUX:3.92e-05", ...)
    Dim tokens() As String
    Dim i        As Integer
...
End Sub
Private Sub WLFT_DIBC_Lib_UVS256HP_C(tNum As String, argarray As Variant)
On Error GoTo errHandler
 ' argArray =  Array("VDD12_ADC:4.15e-05","VDD12_AMUX:3.92e-05", ...)
    Dim tokens() As String
    Dim i        As Integer
...
End Sub
Private Sub WLFT_DIBC_Lib_UVS256HP_R(tNum As String, argarray As Variant)
End Sub
Private Sub WLFT_DIBC_Lib_UP2200_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim Relay_On As String
    Dim Route_Start As String
    Dim Route_End As String
    ...
    For i = 0 To UBound(argarray)
        ...
        Call Relay_Circuit_check(tNum, 6, 0.004, 1.7, 2.3, , 0.003, Route_Start, "")
    Next i
Exit Sub
errHandler:
    TheExec.Datalog.WriteComment "error in DIBC_Lib_UP2200_R"
End Sub
Private Sub WLFT_DIBC_Lib_COMPLEX_PLUS(tNum As String, argarray As Variant)
On Error GoTo errHandler
  'argArray = Array("VDDQL_DDR", "DDR0_RREF", "K31", "DDR1_RREF", "K32", "DDR2_RREF", "K33", "DDR3_RREF", "K34")
    ' Dim powerPin As String: powerPin = argArray(0)
    ' Dim p1       As String
    ...
    For i = 1 To UBound(argarray) Step 3
        ...
        k2 = argarray(i + 2)
        TheHdw.Utility.pins(k1).State = tlUtilBitOff
        Call Relay_Circuit_check(tNum, 6, 0.004, 1.7, 2.3, k2, 0.003, p1, powerPin)
    Next i
...
End Sub
Private Sub WLFT_DIBC_Lib_UVS256HP_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
'argArray = Array("PAD_MTR_ANALOG_TEST_N","K10","1.20e-06")
    Dim Relay_On As String
    Dim Test_PinName As String
...
Private Sub WLFT_DIBC_Lib_UVS256_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
'argArray = Array("PAD_MTR_ANALOG_TEST_N","K10","1.20e-06")
    Dim Relay_On As String
    Dim Test_PinName As String
...
Private Sub WLFT_DIBC_Lib_Uvi80_C_Cap(tNum As String, argarray As Variant)
    ...
    Call UVI80_Cap_Leakage(tNum, Test_PinName)
        Call DCVI_Cap_Meas_2(tNum + 10, Test_PinName, "", Cap_Current, Cap_ChargeVoltage, Cap_Voltageoffset)
...
Private Sub WLFT_DIBC_Lib_UP2200_RELAY_R(tNum As String, argarray As Variant)
On Error GoTo errHandler
' argArray = Array("ATC1_USB_RESREF","K32","K33")
    Dim p1 As String: p1 = argarray(0)
    Dim k1 As String: k1 = argarray(1)
...
Private Sub WLFT_DIBC_Lib_UP2200_RELAY_C_3(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim p1 As String: p1 = argarray(0)
    Dim p2 As String: p2 = argarray(1)
    Dim k1 As String: k1 = argarray(2)
...
Private Sub WLFT_DIBC_Lib_UP2200_RELAY_C_4(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim p1 As String: p1 = argarray(0)
    Dim p2 As String: p2 = argarray(1)
    Dim k1 As String: k1 = argarray(2)
    ...
    Call DIBC_PPMU_Relay_FIMV_rising_new(CStr(CLng(tNum) + 30), k1, p2)
        ...
        Call Relay_Circuit_check(CStr(CLng(tNum) + 40), 6, 0.004, 1.7, 2.3, k1, 0.003, p1, "")
...
Private Sub WLFT_DIBC_Lib_UP2200_RELAY_R2(tNum As String, argarray As Variant)
On Error GoTo errHandler
     ' argArray = Array("RT_CLK32768","RT_CLK32768_PA","K01")
...
End Sub
Private Sub WLFT_DIBC_Lib_UVS256HP_RELAY_R1(tNum As String, argarray As Variant)
On Error GoTo errHandler
    Dim Relay_On As String
    Dim Route_Start As String
    Dim Route_End As String
...
On Error GoTo errHandler
   ...
   ' TheHdw.Utility.pins("K04").State = tlUtilBitOn
    ...
    'Dim spiRomPat As String: spiRomPat = TheExec.TestProgram.Path + "\\" + DIBC_FOLDER + "\\Patterns\\SPIROMReadStatus.PATX"
    If dibonTesterType = "Jaguar" Then
...
On Error GoTo errHandler
    ...
    'Dim spiRomDebugPat As String: spiRomDebugPat = TheExec.TestProgram.Path + "\\" + DIBC_FOLDER + "\\Patterns\\SPIROMReadID_Debug.PATX"
    If dibonTesterType = "Jaguar" Then
...
'    On Error GoTo errHandler
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, LoadLevels:=True, LoadTiming:=True, RelayMode:=tlPowered, PinLevelsSheet:="DIBC_TSets__WLFT", TimeSetSheet:="DIBC_Levels__WLFT" ''May2 added
        '''0831 by rita
...
On Error GoTo errHandler
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, LoadLevels:=True, LoadTiming:=True, RelayMode:=tlPowered, PinLevelsSheet:="DIBC_Levels__WLFT", TimeSetSheet:="DIBC_TSets__WLFT"
...
'    On Error GoTo 0
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, RelayMode:=tlPowered, LoadLevels:=True, LoadTiming:=True, _
                                     PinLevelsSheet:="DIBC_Levels__WLFT", TimeSetSheet:="DIBC_TSets__WLFT"
...
On Error GoTo errHandler
    ...
    TheHdw.Digital.ApplyLevelsTiming ConnectAllPins:=False, LoadLevels:=True, LoadTiming:=True, RelayMode:=tlPowered, PinLevelsSheet:="DIBC_Levels__WLFT", TimeSetSheet:="DIBC_TSets__WLFT"  '0831 by rita 'DIBC_TSets__
    TheHdw.Wait 0.01
...
Private Sub WLFT_DIBC_Test_4000()
    WLFT_DIBC_Lib_MeasureIOleakage 4000, Array()
End Sub

Private Sub WLFT_DIBC_Test_4100()
    WLFT_DIBC_Lib_UtilityCheck 4100, Array()
End Sub

Private Sub WLFT_DIBC_Test_5000()
    WLFT_DIBC_Lib_SPI_ROM 5000, Array("K110", "K111", "K58", "K59", "K60", "K61")
End Sub

Private Sub WLFT_DIBC_Test_10000()
    WLFT_DIBC_Lib_UP1600_IO 10000, Array("AON_SLEEP1_RESETN", "AOP_I2CM0_SCL", "AOP_I2CM0_SDA", "AOP_I2CM1_SCL", "AOP_I2CM1_SDA", "AOP_I2CM2_SCL", "AOP_I2CM2_SDA", "AOP_I2CM3_SCL", "AOP_I2CM3_SDA", "AOP_I2S0_BCLK", "AOP_I2S0_DIN", "AOP_I2S0_DOUT", "AOP_I2S0_LRCK", "AOP_I2S0_MCK", "AOP_I2S1_BCLK", "AOP_I2S1_DIN", "AOP_I2S1_DOUT", "AOP_I2S1_LRCK", "AOP_I2S1_MCK", "AOP_I2S2_BCLK", "AOP_I2S2_DIN", "AOP_I2S2_DOUT", "AOP_I2S2_LRCK", "AOP_I2S2_MCK", "AOP_I2S3_BCLK", "AOP_I2S3_DIN", "AOP_I2S3_DOUT", "AOP_I2S3_LRCK", "AOP_I2S4_BCLK", "AOP_I2S4_DIN", "AOP_I2S4_DOUT", "AOP_I2S4_LRCK", "AOP_I2S5_BCLK", "AOP_I2S5_DIN", "AOP_I2S5_DOUT", _
...
"UID_MODE_L", "UNTRUSTED_BOOTCONFIG", "VSS_1", "VSS_2", "VSS_3", "VSS_4", "WDOG_L")
End Sub

Private Sub WLFT_DIBC_Test_40000()
    WLFT_DIBC_Lib_UP1600_RELAY 40000, Array("RT_CLK32768", "RT_CLK32768_PA", "K1")
End Sub

Private Sub WLFT_DIBC_Test_60000()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60000, Array("ATC0_USB_RESREF", "K46", "K47")
End Sub

Private Sub WLFT_DIBC_Test_60100()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60100, Array("DBG_USB_RESREF", "K48", "K49")
End Sub

Private Sub WLFT_DIBC_Test_60200()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60200, Array("DIE_CORNER_DC_NE", "K56", "K57")
End Sub

Private Sub WLFT_DIBC_Test_60300()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60300, Array("DIE_CORNER_DC_NW", "K50", "K51")
End Sub

Private Sub WLFT_DIBC_Test_60400()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60400, Array("DIE_CORNER_DC_SE", "K52", "K53")
End Sub

Private Sub WLFT_DIBC_Test_60500()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60500, Array("DIE_CORNER_DC_SW", "K54", "K55")
End Sub

Private Sub WLFT_DIBC_Test_60600()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60600, Array("MIPIC0_REXT", "K42", "K43")
End Sub

Private Sub WLFT_DIBC_Test_60700()
    WLFT_DIBC_Lib_UP1600_RELAY_R_2 60700, Array("MIPID_REXT", "K44", "K45")
End Sub

Private Sub WLFT_DIBC_Test_70000()
    WLFT_DIBC_Lib_UP1600_RELAY_2 70000, Array("XI0", "XI0_PA", "XO0", "XO0_PA", "K73")
End Sub

Private Sub WLFT_DIBC_Test_200000()
    WLFT_DIBC_Lib_UVI80_RELAY 200000, Array("VDD_PCPU_ABSMIN", "K66")
End Sub

Private Sub WLFT_DIBC_Test_240000()
    WLFT_DIBC_Lib_UVI80_RELAY_R 240000, Array("ANALOGMUX_OUT_POS_SRC", "K69", "K68", "K67")
End Sub

Private Sub WLFT_DIBC_Test_240100()
    WLFT_DIBC_Lib_UVI80_RELAY_R 240100, Array("ANALOGMUX_OUT_NEG_SRC", "K72", "K71", "K70")
End Sub

Private Sub WLFT_DIBC_Test_400000()
    WLFT_DIBC_Lib_UVS256_C 400000, Array("VDD12_ADC_SOC:2.14e-05", "VDD12_AMUX_FMON:2.20e-05", "VDD12_CIO:3.25e-05", "VDD12_EFUSE1:3.71e-05", "VDD12_EFUSE2:3.66e-05", "VDD12_EFUSE3:3.65e-05", "VDD12_HSCDFT0:3.55e-05", "VDD12_HSCDFT1:3.54e-05", "VDD12_LPDP_RX:6.62e-05", "VDD12_LPDP_TX:2.27e-05", "VDD12_MIPI:2.20e-05", "VDD12_PCIE:5.77e-05", "VDD12_PCIE_REFBUF:2.21e-05", "VDD12_PLL:3.14e-05", "VDD12_PLL_DCS:2.20e-05", "VDD12_PLL_DDR:2.72e-05", "VDD12_PLL_SOC:2.15e-05", "VDD12_SLC_PLL:2.15e-05", "VDD12_ULPPLL_FLPPLL:2.21e-05", "VDD12_USB:2.26e-05", "VDD12_USB_DEBUG:2.20e-05", "VDD12_VID_PLL:2.16e-05", _
"VDD12_XTAL:2.15e-05", "VDD1:5.11e-05", "VDD2:1.37e-04", "VDDIO12_AOP:1.22e-04", "VDDIO12_AOP_2:5.50e-05", "VDDIO12_GRP:7.26e-05", "VDD_AMPH_DDR:8.16e-05", "VDD_AVE:1.31e-04", "VDD_DCS_DDR:1.35e-04", "VDD_DISP:1.28e-04", "VDD_FIXED:4.76e-05", "VDD_FIXED_AMUX:3.65e-05", "VDD_FIXED_CIO:2.93e-05", "VDD_FIXED_CPU:2.61e-05", "VDD_FIXED_ECPU_MTR:3.35e-05", "VDD_FIXED_MIPI:2.31e-05", "VDD_FIXED_MIPID_PLL:2.25e-05", "VDD_FIXED_MIPID_SOC:2.40e-05", "VDD_FIXED_MTR_CPM_PCPU:2.14e-05", "VDD_FIXED_PCIE:3.58e-05", "VDD_FIXED_PCIE_REFBUF:2.30e-05", "VDD_FIXED_PLL:2.30e-05", _
"VDD_FIXED_PLL_DCS:2.15e-05", "VDD_FIXED_PLL_SOC:2.15e-05", "VDD_FIXED_USB:2.26e-05", "VDD_FIXED_XTAL:2.15e-05", "VDD_LOW:5.16e-05", "VDD_SRAM_GPU:1.53e-04", "VDD_SRAM_ULPPLL_FLPPLL_SLC:2.35e-05", "VDD_SRAM_USB_DEBUG:2.20e-05", "VDD_SRAM_VID_PLL:2.16e-05")
End Sub

Private Sub WLFT_DIBC_Test_410000()
    WLFT_DIBC_Lib_UVS256_RELAY_UP1600 410000, Array("VDDQL_DDR", "DDR0_RREF", "K15", "DDR0_RREF", "K14", "DDR0_ZQ", "K12", "DDR0_ZQ", "K13", "DDR1_RREF", "K17", "DDR1_RREF", "K16", "DDR2_RREF", "K19", "DDR2_RREF", "K18", "DDR3_RREF", "K20", "DDR3_RREF", "K21")
End Sub

Private Sub WLFT_DIBC_Test_420000()
    WLFT_DIBC_Lib_HEXVS_C 420000, Array("VDD_CPU_SRAM:5.14e-04", "VDD_ECPU:5.19e-04", "VDD_GPU:8.62e-04", "VDD_PCPU:8.79e-04", "VDD_SOC:7.44e-04", "VDD_SRAM_SOC:5.05e-04")
End Sub

Private Sub WLFT_DIBC_Test_610000()
    WLFT_DIBC_Lib_DIFF_RELAY 610000, Array("LPDPRX1_RCAL_POS", "LPDPRX1_RCAL_NEG", "K34", "K35", "K36", "K37", "1.00e-11")
End Sub

Private Sub WLFT_DIBC_Test_610100()
    WLFT_DIBC_Lib_DIFF_RELAY 610100, Array("LPDPRX0_RCAL_POS", "LPDPRX0_RCAL_NEG", "K30", "K31", "K32", "K33", "1.00e-11")
End Sub

Private Sub WLFT_DIBC_Test_610200()
    WLFT_DIBC_Lib_DIFF_RELAY 610200, Array("ATC0_RCAL_POS", "ATC0_RCAL_NEG", "K22", "K23", "K24", "K25", "1.00e-11")
End Sub

Private Sub WLFT_DIBC_Test_610300()
    WLFT_DIBC_Lib_DIFF_RELAY 610300, Array("LPDPTX_RCAL_POS", "LPDPTX_RCAL_NEG", "K26", "K27", "K28", "K29", "1.00e-11")
End Sub

Private Sub WLFT_DIBC_Test_610400()
    WLFT_DIBC_Lib_DIFF_RELAY 610400, Array("PCIE_RCAL_P", "PCIE_RCAL_N", "K38", "K39", "K40", "K41", "1.00e-11")
End Sub

Private Sub WLFT_DIBC_Test_620000()
    WLFT_DIBC_Lib_FRC_BUFFER 620000, Array("NONE")
End Sub

Private Sub WLFT_DIBC_Test_630000()
    WLFT_DIBC_Lib_LOOP_BACK 630000, Array("ATC0_RX0_N", "ATC0_TX0_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630100()
    WLFT_DIBC_Lib_LOOP_BACK 630100, Array("ATC0_RX0_P", "ATC0_TX0_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630200()
    WLFT_DIBC_Lib_LOOP_BACK 630200, Array("ATC0_RX1_N", "ATC0_TX1_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630300()
    WLFT_DIBC_Lib_LOOP_BACK 630300, Array("ATC0_RX1_P", "ATC0_TX1_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630400()
    WLFT_DIBC_Lib_LOOP_BACK 630400, Array("GP_PCIE_RX0_N", "GP_PCIE_TX0_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630500()
    WLFT_DIBC_Lib_LOOP_BACK 630500, Array("GP_PCIE_RX0_P", "GP_PCIE_TX0_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630600()
    WLFT_DIBC_Lib_LOOP_BACK 630600, Array("GP_PCIE_RX1_N", "GP_PCIE_TX1_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630700()
    WLFT_DIBC_Lib_LOOP_BACK 630700, Array("GP_PCIE_RX1_P", "GP_PCIE_TX1_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630800()
    WLFT_DIBC_Lib_LOOP_BACK 630800, Array("LPDPRX_D0_N", "LPDPRX_D1_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_630900()
    WLFT_DIBC_Lib_LOOP_BACK 630900, Array("LPDPRX_D0_P", "LPDPRX_D1_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631000()
    WLFT_DIBC_Lib_LOOP_BACK 631000, Array("LPDPRX_D2_N", "LPDPRX_D3_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631100()
    WLFT_DIBC_Lib_LOOP_BACK 631100, Array("LPDPRX_D2_P", "LPDPRX_D3_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631200()
    WLFT_DIBC_Lib_LOOP_BACK 631200, Array("LPDPRX_D4_N", "LPDPRX_D5_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631300()
    WLFT_DIBC_Lib_LOOP_BACK 631300, Array("LPDPRX_D4_P", "LPDPRX_D5_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631400()
    WLFT_DIBC_Lib_LOOP_BACK 631400, Array("LPDPRX_D6_N", "LPDPRX_D7_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631500()
    WLFT_DIBC_Lib_LOOP_BACK 631500, Array("LPDPRX_D6_P", "LPDPRX_D7_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631600()
    WLFT_DIBC_Lib_LOOP_BACK 631600, Array("LPDPRX_D8_N", "LPDPRX_D9_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631700()
    WLFT_DIBC_Lib_LOOP_BACK 631700, Array("LPDPRX_D8_P", "LPDPRX_D9_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631800()
    WLFT_DIBC_Lib_LOOP_BACK 631800, Array("ST_PCIE_RX0_N", "ST_PCIE_TX0_N", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_631900()
    WLFT_DIBC_Lib_LOOP_BACK 631900, Array("ST_PCIE_RX0_P", "ST_PCIE_TX0_P", "2.20e-07")
End Sub

Private Sub WLFT_DIBC_Test_650000()
    WLFT_DIBC_Lib_SB_EEPROM 650000, Array("NONE")
End Sub

Private Sub WLFT_DIBC_Test_660000()
    WLFT_DIBC_Lib_SB_Power 660000, Array()
End Sub

Private Sub WLFT_DIBC_Test_900000()
    WLFT_DIBC_Lib_Uvi80_C_Cap 900000, Array("VDD_FIXED_LPDP_RX", "C1086", "6.71e-05")
End Sub

Private Sub WLFT_DIBC_Test_900100()
    WLFT_DIBC_Lib_Uvi80_C_Cap 900100, Array("VDD_FIXED_LPDP_TX", "C1211", "3.50e-05")
End Sub
