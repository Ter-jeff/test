...
Public Const AllDCVIPinlist = "All_DCVI_Analog"
...
Public Const All_DigitalPinlist_Disc_ESD = "All_Digital_Disc_ESD"   'need to remove refclk, PA pins pins
Public Const All_Utility_list = "All_support"
...
Public Const PinGrouplist = "Pins_1p2v,Pins_1p12V,Pins_0p805v,Pins_0p55v"    ',DDR_IO_GP,DDR_Vref,Efuse_Data_Out,PLL_Pins_1p8v,LPDP_IO_GP,LPDP_TX3_Diff,PCIE_IO_GP,MIPI_IO_GP,PCIE_REF,Pcie_txrx_io,Group_A,gpio20,SEP_SPI_MISO,GPIO_leak,ULPI_DIR"
...
Public IDS_VDD_AVE As New SiteVariant
Public IDS_VDD_CPU_SRAM As New SiteVariant
Public IDS_VDD_DCS_DDR As New SiteVariant
Public IDS_VDD_DISP As New SiteVariant
Public IDS_VDD_ECPU As New SiteVariant
Public IDS_VDD_FIXED As New SiteVariant
Public IDS_VDD_GPU As New SiteVariant
Public IDS_VDD_LOW As New SiteVariant
Public IDS_VDD_PCPU As New SiteVariant
Public IDS_VDD_SOC As New SiteVariant
Public IDS_VDD_SRAM_GPU As New SiteVariant
Public IDS_VDD_SRAM_SOC As New SiteVariant

Public Delta_IDS_VDD_SOC As New SiteVariant
Public Delta_IDS_VDD_DISP As New SiteVariant
Public Delta_IDS_VDD_ICS_MCU_IONA As New SiteVariant
Public Delta_IDS_VDD_ICS_PHY_IONA As New SiteVariant
Public Delta_IDS_VDD_FIXED As New SiteVariant
Public Delta_IDS_VDD_LOW As New SiteVariant
Public Delta_IDS_VDD_CIO As New SiteVariant
Public Delta_IDS_VDD_SRAM As New SiteVariant

Public Delta_IDS_VDD_AVE As New SiteVariant
Public Delta_IDS_VDD_CPU_SRAM As New SiteVariant
Public Delta_IDS_VDD_PCPU As New SiteVariant
Public Delta_IDS_VDD_ECPU As New SiteVariant
Public Delta_IDS_VDD_GPU As New SiteVariant
Public Delta_IDS_VDD_DCS_DDR As New SiteVariant

'20220616 Mason - Add Coll IDS WLFT1 delta power pin for IEDA
Public Delta_IDS_VDD_SRAM_GPU As New SiteVariant
Public Delta_IDS_VDD_SRAM_SOC As New SiteVariant
'====================================================
...
'Public gl_FlowForLoop_DigSrc_SweepCode_Dec As String '20190613 CT
...
Public Const io_l_pins_down = "InitLo_Pins_Down"
...
'sequence99 and NC pins print out for powerup
Public gls_Powersequence99_log As String
Public gls_PowersequenceNC_log As String
'power down TTR
Public gln_TempMaxSequence_down_GB As Long
Public glsa_PowerSequencePin_down_GB() As String
Public glb_PD_parsing_once As Boolean

Public Flag_Find_nWire_Pin_CHK As Boolean
Public parse_DC_version_CHK As Boolean 'parse only one time
'================================================
Public site As Variant

Public gL_License_check As Long
Public glb_TestInstance As String
Public glb_TestInstance_TMPS As String ''From T-Col

Public glb_TMPS_fail_flag As Boolean
Public glb_TMPS_start_flag As Boolean
Public glb_TMPS_end_flag As Boolean
Public glb_TMPS_timer As Variant
'''''Add by TY
Public glb_TMPS_count_str As String
Public glb_TMPS_count_int As Long
Public TMPS_Fail As Boolean
Public Time0 As Variant
Public glb_MTRRecord As String
Public glb_MTRBTSCnt As Long
...
Public gl_preconditionMismatchPat As String
...
Public gls_Excel_Version As String
Public gls_HIPTTR_Version As String
Public gls_TestPlanVersion As String
Public gls_gS_Char_Version As String
Public gls_EfuseVersion As String
Public gls_BinCutVersion As String
Public gls_DC_Table_Ver As String
Public gls_Binary_Ver As String
...
Public glb_ProjectName  As String
...
Public gl_bTTRDisableAlarm As Boolean ''Alarm check disable for ATPG and BV 23230530
Public gl_bTInitializeVMain As Boolean ''Initialize VMain disable for ATPG, Functional_t_Updated 23230530
...
Public F_p2pWT As Boolean
Public PowerPin_range_ary_CRWT() As AutoRange_Info
Public Dict_CRWT_TuneTime As New Dictionary
...
Public Glb_Bool_CheckSFCInitPat As Boolean
...
'michael for dram
Type ContiResult
    InstName As New Dictionary
    ForceCondition As New Dictionary
    result As New Dictionary
End Type

Public glb_PowerShort As ContiResult

Public glb_CheckSSNToSFC As Boolean

Public ffc_Start As Long
Public ffc_Stop As Long
Public ffc_do_it As Long
