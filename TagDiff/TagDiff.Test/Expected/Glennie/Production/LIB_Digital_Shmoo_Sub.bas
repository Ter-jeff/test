    ...
    For i = start_point To str_len
        ...
        If Not (search_dif) Then
            If (char_pt = "F") Then '#16_ELSE_CASE_CHK
                report_point = i - 1
                search_dif = True
                                If gl_BY_PASS_SHMOO_HOLE Or TheExec.enableWord("Byp_ShmooHole_HVCC") Then Exit For 'add by Leslie 200921
    ...
    For i = start_point To 1 Step -1
        ...
        If Not (search_dif) Then
            If (char_pt = "F") Then '#16_ELSE_CASE_CHK
                report_point = i + 1
                search_dif = True
                                If gl_BY_PASS_SHMOO_HOLE Or TheExec.enableWord("Byp_ShmooHole_LVCC") = True Then Exit For  'add by Leslie 200915
