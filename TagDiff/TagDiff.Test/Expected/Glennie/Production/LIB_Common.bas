...
On Error GoTo errHandler
    ...
    ElseIf (m_siteCnt = 4) Then
        If (m_chmapName Like "*ch*4*") Then
            ...
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(0, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(1, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(2, x + 3)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(3, x + 3)
            
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(0, y)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(1, y - 3)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(2, y)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(3, y - 3)
            Debug.Print "Site0: " & "(" & x & "," & y & ")"
            Debug.Print "Site1: " & "(" & x & "," & y - 3 & ")"
            Debug.Print "Site2: " & "(" & x + 3&; "," & y & ")"
            Debug.Print "Site3: " & "(" & x + 3&; "," & y - 3 & ")"
        End If
    ElseIf (m_siteCnt = 5) Then
        If (m_chmapName Like "*ch*5*") Then
            m_match_flag = True
             If UCase(m_chmapName) Like "*CP*" Then
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(0, x)
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(1, x + 2)
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(2, x + 4)
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(3, x + 6)
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(4, x + 8)
                ...
                Debug.Print "Site0: " & "(" & x & "," & y & ")"
                Debug.Print "Site1: " & "(" & x + 2 & "," & y - 3 & ")"
                Debug.Print "Site2: " & "(" & x + 4&; "," & y & ")"
                Debug.Print "Site3: " & "(" & x + 6&; "," & y - 3 & ")"
                Debug.Print "Site4: " & "(" & x + 8&; "," & y & ")"
        ...
        If (m_chmapName Like "*ch*6*") Then
            m_match_flag = True
             If UCase(m_chmapName) Like "*CP*" Then
                ...
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(2, x + 3)
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(3, x + 3)
                Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(4, x + 6)
                ...
                Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(3, y - 3)
                Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(4, y)
                Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(5, y - 3)
                
                Debug.Print "Site0: " & "(" & x & "," & y & ")"
                Debug.Print "Site1: " & "(" & x & "," & y - 3 & ")"
                Debug.Print "Site2: " & "(" & x + 3&; "," & y & ")"
                Debug.Print "Site3: " & "(" & x + 3&; "," & y - 3 & ")"
                Debug.Print "Site4: " & "(" & x + 6&; "," & y & ")"
                Debug.Print "Site5: " & "(" & x + 6&; "," & y - 3 & ")"
    ...
    ElseIf (m_siteCnt = 8) Then
        ...
        End If
    ElseIf (m_siteCnt = 16) Then
        If (m_chmapName Like "*ch*16*") Then
            m_match_flag = True
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(0, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(1, x + 5)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(2, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(3, x + 5)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(4, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(5, x + 5)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(6, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(7, x + 5)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(8, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(9, x + 5)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(10, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(11, x + 5)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(12, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(13, x + 5)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(14, x)
            Call TheExec.Datalog.Setup.WaferSetup.SetXCoord(15, x + 5)
            
            
            
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(0, y)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(1, y)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(2, y - 3)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(3, y - 3)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(4, y - 6)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(5, y - 6)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(6, y - 9)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(7, y - 9)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(8, y - 12)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(9, y - 12)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(10, y - 15)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(11, y - 15)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(12, y - 18)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(13, y - 18)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(14, y - 21)
            Call TheExec.Datalog.Setup.WaferSetup.SetYCoord(15, y - 21)
            
            Debug.Print "Site0: " & "(" & x & "," & y & ")"
            Debug.Print "Site1: " & "(" & x + 5 & "," & y & ")"
            Debug.Print "Site2: " & "(" & x & "," & y - 3 & ")"
            Debug.Print "Site3: " & "(" & x + 5 & "," & y - 3 & ")"
            Debug.Print "Site4: " & "(" & x & "," & y - 6 & ")"
            Debug.Print "Site5: " & "(" & x + 5 & "," & y - 6 & ")"
            Debug.Print "Site6: " & "(" & x & "," & y - 9 & ")"
            Debug.Print "Site7: " & "(" & x + 5 & "," & y - 9 & ")"
            Debug.Print "Site8: " & "(" & x & "," & y - 12 & ")"
            Debug.Print "Site9: " & "(" & x + 5 & "," & y - 12 & ")"
            Debug.Print "Site10: " & "(" & x & "," & y - 15 & ")"
            Debug.Print "Site11: " & "(" & x + 5 & "," & y - 15 & ")"
            Debug.Print "Site12: " & "(" & x & "," & y - 18 & ")"
            Debug.Print "Site13: " & "(" & x + 5 & "," & y - 18 & ")"
            Debug.Print "Site14: " & "(" & x & "," & y - 21 & ")"
            Debug.Print "Site15: " & "(" & x + 5 & "," & y - 21 & ")"
...
Public Function DebugPrintFunc(Test_Pattern As String, Optional testname_enable As Boolean = False, Optional Hardip_info_flag As Boolean, Optional s_OtherPrintInfo As String = vbNullString) As Long
...
Public Function AddNum()
    ...
    Dim InitNum As Long: InitNum = 8000000
    Dim step As Long: step = 4000
    ...
    c10 = range("AZ5:AZ" + CStr(Sheets(ActiveSheet.name).UsedRange.Rows.Count)).value
    
    For x = 1 To UBound(c7)
        If LCase(c7(x, 1)) Like "test" Or LCase(c7(x, 1)) Like "characterize" Then
            c10(x, 1) = InitNum + step * idx
            idx = idx + 1
        End If
        
        If LCase(c7(x, 1)) Like "for" Then x = x + 1
    Next x
    
    range("J5:J" + CStr(Sheets(ActiveSheet.name).UsedRange.Rows.Count)).value = c10
    ...
    If DebugPrintFlag_Chk = True Then
        ...
        For i = 0 To pinCnt - 1
            If TheExec.DataManager.ChannelType(pinAry(i)) <> "N/C" Then
                pin_type = UCase(GetInstrument(pinAry(i), 0))
                If pin_type = "DC-07" Then
                    PowerVolt = TheHdw.DCVI.pins(pinAry(i)).Voltage.value
                Else
                    PowerVolt = TheHdw.DCVS.pins(pinAry(i)).Voltage.Main.value
                End If
...
'    On Error GoTo errhandler
    ...
    If patcnt = 0 Then
        ''' we don't need to handle the TetsPat which is already be relative path format
        If (UCase(TestPat)) Like "*\PATTERN\*" Then ''' validate
            ReDim rtnPatNames(0)
            rtnPatNames(0) = TestPat
            patcnt = 1
            Exit Function
        End If
    End If
...
On Error GoTo errHandler 'Add ErrHandler 2023/08/18
    ...
    For Each nwp In nWire_port_ary
        ...
        If LCase(port_pa) Like LCase("*DIFF*") Then
...
Public Function ProfileAutoResolution(SlotType As String, measuretime As Double, ByRef SampleSize As Double, ByRef SampleRate As Double, Optional DownSampleRatio As Long = 1, Optional nSpecificSampleSize As Long = 0)
    On Error GoTo errHandler
    ...
    Select Case SlotType
        Case glbConstIns_HEXVS
            If measuretime > HexMaxtime Then
                If nSpecificSampleSize > HexVsMaxSampleSize Or nSpecificSampleSize <= 0 Then
                    SampleSize = HexVsMaxSampleSize
                Else
                    SampleSize = nSpecificSampleSize
                End If
                SampleRate = HexVsMaxSampleRate / 1024
            Else
                If nSpecificSampleSize = 0 Then
                    ...
                    End If
                Else
                    If nSpecificSampleSize > HexVsMaxSampleSize Then
                        SampleSize = HexVsMaxSampleSize
                    Else
                        SampleSize = nSpecificSampleSize
                    End If
                    RealRate = SampleSize / measuretime
                End If
                'RealRate = HexVsMaxSampleSize / measuretime
        ...
        Case glbConstIns_VHDVS
            ...
            If measuretime > UVSMaxtime Then
                If nSpecificSampleSize > UVSMaxSampleSize Or nSpecificSampleSize <= 0 Then
            ...
            Else
                If nSpecificSampleSize = 0 Then
                    ...
                    End If
                Else
                    If nSpecificSampleSize > UVSMaxSampleSize Then
                        SampleSize = UVSMaxSampleSize
                    Else
                        SampleSize = nSpecificSampleSize
                    End If
        ...
        Case glbConstIns_VSM
            If measuretime > VSMMaxtime Then
                If nSpecificSampleSize > VSMMaxSampleSize Or nSpecificSampleSize <= 0 Then
            ...
            Else
                If nSpecificSampleSize = 0 Then
                    ...
                    End If
                Else
                    If nSpecificSampleSize > VSMMaxSampleSize Then
                        SampleSize = VSMMaxSampleSize
                    Else
                        SampleSize = nSpecificSampleSize
                    End If
        ...
        Case glbConstIns_VS5A, glbConstIns_VS800MA
            ...
            If measuretime > VSMaxtime Then
                If nSpecificSampleSize > VSMaxSampleSize Or nSpecificSampleSize <= 0 Then
            ...
            Else
                If nSpecificSampleSize = 0 Then
                    ...
                    End If
                Else
                    If nSpecificSampleSize > VSMaxSampleSize Then
                        SampleSize = VSMaxSampleSize
                    Else
                        SampleSize = nSpecificSampleSize
                    End If
...
''            If Pin_range_ary(i).PinName <> "" And Pin_range_ary(i).MergeType <> "N/C" Then
            If Pin_range_ary(i).PinName <> "" Then
                ...
                End If
                If InStr(PinName_Temp, ":C") > 0 And PinMerged_Temp <> "N/C" Then
...
''            If Pin_range_ary(i).PinName <> "" Then
                ...
                Else
                    ...
                    If Pin_range_ary(i).PinMapType Like "*Power*" Then
                        ...
                        ReDim Preserve PowerPin_range_ary_CRWT(j)
    ...
    If Not F_p2pWT Then
        PowerPin_range_ary_CRWT = PowerPin_range_ary
        F_p2pWT = CRWT.LoadCRWTToPowerPinAry("TuneCRWTResult_" & UCase(currentJobName))
        If F_p2pWT Then
            Set Dict_CRWT_TuneTime = CRWT.Dict_TuneTime
        Else
            Dict_CRWT_TuneTime.RemoveAll
        End If
    End If
    Exit Function
            ...
            If Not (patSel) Then
                If LCase(pat) Like "*.pat*" Then
                    ...
                    If patcnt <> 1 Then
                        ...
                        If TheExec.TesterMode = testModeOffline Then TheExec.AddOutput "It directly used path in patset of " & TestPat
                    Else
                        Erase rtnPatNames
...
On Error GoTo errHandler
    ''20240115 PrintOut TTR
    Dim mAS_AllEnableWords() As String
    Dim mL_AllEnWrdsCnt As Long
    Dim mL_Loop As Long

    
    If glb_isParsing_EW = False Or isDebugMode = True Then
        
        If gls_Active_EW <> "" Or gls_Disable_EW <> "" Then
        ...
        For mL_Loop = 0 To UBound(mAS_AllEnableWords)
            If TheExec.enableWord(mAS_AllEnableWords(mL_Loop)) Then
                gls_Active_EW = gls_Active_EW & mAS_AllEnableWords(mL_Loop) & "|"   'mS_Active_EW = mS_Active_EW & mAS_AllEnableWords(mL_Loop) & "|"
            Else
                gls_Disable_EW = gls_Disable_EW & mAS_AllEnableWords(mL_Loop) & "|"     'mS_Disable_EW = mS_Disable_EW & mAS_AllEnableWords(mL_Loop) & "|"
            End If
        Next
    ...
    If glb_isRunOptions_Info = False Or isDebugMode = True Then
...
On Error GoTo errHandler 'Add ErrHandler 2023/08/18
    ...
    latestTenMean = CurrentProfile_Ten.Select(CurrentProfile_Ten.SampleSize * (1 - 0.1), , CurrentProfile_Ten.SampleSize).CalcMean
                ...
                If bJobMatch Then
                    ...
                    For R = nStartRow To nSheetMaxRow
                        If IgnoreItem(CStr(ParsingArr(R, nInstanceNameCol))) = False Then
                            If glb_ExecutionProfile_Dict.Exists(LCase(CStr(ParsingArr(R, nCurrentColPos)) & "_" & CStr(ParsingArr(R, nInstanceNameCol)))) = False Then
                                glb_ExecutionProfile_Dict.Add LCase(CStr(ParsingArr(R, nCurrentColPos)) & "_" & CStr(ParsingArr(R, nInstanceNameCol))), CDbl(ParsingArr(R, nTimeCol))
                            End If
                        End If
                    Next R
...
Public Function ProfileCollect_Start(TestInstan_Str As String)
    ...
    If gl_EnableVoltageProfile Or gl_EnableCurrentProfile Then
        ...
        If gl_isParExecutionProfileSheet = True Then
            ...
            If s_PlotName <> "" Then
                If glb_ExecutionProfile_Dict.Exists(LCase(sTemp)) Then

                    PlotTime_D = glb_ExecutionProfile_Dict.item(LCase(sTemp))
                    If glb_CurrentProfile_Dict.item(s_PlotName)(0) <> "" Then
                        PinName_S = glb_CurrentProfile_Dict.item(s_PlotName)(0)
                    Else
                        PinName_S = Core_Power_DCVS_pins + "," + Core_Power_DCVI_pins  'PinName_S = "CorePower"
                    End If
                    s_SampleSize = glb_CurrentProfile_Dict.item(s_PlotName)(1)
                    If s_SampleSize = "" Then s_SampleSize = 0
                    
                    If gl_EnableVoltageProfile Then
                        Start_Profile_AutoResolution PinName_S, "V", , PlotTime_D + 0.01, False, CLng(s_SampleSize)
                    ElseIf gl_EnableCurrentProfile Then
                        Start_Profile_AutoResolution PinName_S, "I", , PlotTime_D + 0.01, False, CLng(s_SampleSize)
                    End If
                Else
...
Public Function ProfileCollect_End(TestInstan_Str As String)
    ...
    If gl_EnableVoltageProfile Or gl_EnableCurrentProfile Then
        ...
        If gl_isParExecutionProfileSheet = True Then
            ...
            If s_PlotName <> "" Then
                If glb_ExecutionProfile_Dict.Exists(LCase(sTemp)) And _
...
''        d_StartVoltage = FormatNumber(thehdw.DCVS.Pins(s_GRP_Pin_List(i)).Voltage.value, 3)
    ...
    Dim sb_Gate As New SiteBoolean
        ...
        For EVS_Index = 1 To Step_number
            For i = 0 To UBound(s_GRP_Pin)
                ...
                If Open_LatchUp_Measure Then
                    ...
                    If TheExec.enableWord("CurrentProfile") = True Then
    ...
    For Each site In TheExec.sites
        If sb_Gate.Any(True) Then
''            TheExec.sites.Selected = sb_Gate.LogicalXor(True)
            For i = 0 To UBound(s_Pin_Ary)
                TheHdw.DCVS.pins(s_Pin_Ary(i)).Gate = False
                TheHdw.Wait 0.0001
            Next i
            TheExec.sites(site).FlagState("F_EVS_Alarm_VBT") = logicTrue ''wayne 230907, In order to separate EVS alarm or total power overlimit
'''            TheExec.sites.Selected = True
        End If
    Next site
        ...
        For i = 0 To UBound(DiffPinName)
            ...
            If InStr(1, UCase(DiffPinName(i)), "_PA") <> 0 Then
                If UCase(DiffPinName(i)) Like "*XI*_PA" Then
                    ...
                    For Each site In TheExec.sites.Active
                        If ((MeasClock.pins(DiffPinName(i)).value(site) - targetClock) / targetClock) > (Threshold_Range / 100) Then
                            Call MsgBox("Wrong clock setup, Please use T-Autogen freerunning clock calculate tool", vbCritical)
...
On Error GoTo errHandler
    ...
    Dim s_Pin_Ary() As String, s_Pin_count As Long, pin As Variant, i As Variant
    
    If s_Pin <> "" Then
        
        If LCase(s_Pin) = "all_io" Then
            TheExec.DataManager.DecomposePinList s_Pin, s_Pin_Ary(), s_Pin_count
           
            s_Pin = s_Pin_Ary(0)
            For i = 1 To s_Pin_count - 1
                If Not (LCase(s_Pin_Ary(i)) Like "refclk_*") Then
                    s_Pin = s_Pin + "," + s_Pin_Ary(i)
...
'        For p_cnt = 0 To UBound(sl_ReturnString)
'            Set sl_ReturnString(p_cnt) = New SiteLong
'        Next p_cnt
...
''                    Next j
            ...
            Else
                ...
                sl_Sdomain = CLng(mid(s_DSSC_EQ_Assignment, i + 1, 1))
                Set sl_ReturnString(i) = sl_Sdomain
            End If
            Set pld_LogicValue = Nothing
            Set pld_SramValue = Nothing
...
Public Function Decide_Switching_Bit_New(digSrc_EQ As String, DSPWaveSwitch As DSPWave, DC_Level As PinListData, BlockType As String, SELSRM_Rails As String, Optional shmoo_pin As String, Optional ShmooPinsVoltage As PinListData, Optional ForcePin As String, Optional SetForceVoltage As Dictionary, Optional DSSCPatName As String, Optional set_init As Boolean, Optional seq As Long, Optional Power_Run_Scenario As String) As String
    ...
    If l_Selsram_index <> -1 Then
        Call SelSRAM_DigSrc_Bit(l_Selsram_index, digSrc_EQ, DSSC_Switching_Voltage, DSPWaveSwitch, ReturnString, sl_ReturnString)
        If TheExec.DevChar.Setups.IsRunning = False Then
           Decide_Switching_Bit_New = Join(ReturnString, "")
           SELSRM_Rails = DecodingRealSourceBit(Decide_Switching_Bit_New, BlockType, DSSCPatName)
        Else
           Decide_Switching_Bit_New = digSrc_EQ
           SELSRM_Rails = DecodingRealSourceBit(Decide_Switching_Bit_New, BlockType, DSSCPatName)
        End If
...
errHandler:
    Call Print_Error_Message(Error_Info, "LIB_Common", "Decide_Switching_Bit_New")
    If AbortTest Then Exit Function Else Resume Next
End Function

Public Function GetUsedPinNameForDCVI(pin As String) As String
    ...
    If RegEx.test(pin) And TheExec.DataManager.ChannelType(pin) <> "N/C" Then
        GetUsedPinNameForDCVI = RegEx.Replace(pin, "")
    Else
        GetUsedPinNameForDCVI = pin
    End If
...
Public Function Check_Program_Name() As String
On Error GoTo errHandler

    Dim RegEx As Object
    Dim Regular_Format As String
    Dim ProgramName As String
    Dim Check_type As Integer
    Dim Bool_IllegalFormat As Boolean
    
    Bool_IllegalFormat = False
    
    ProgramName = TheExec.TestProgram.name
    'ProgramName = "!UA28_CP1_X5_E02_240726_V02A_ENG_BCV0P1_CO_25C_CheckProgramName.igxl"
   
    'Define allow character.
    Regular_Format = "^[a-zA-Z0-9\_\-\.]+$"

    Set RegEx = CreateObject("vbscript.regexp")
    With RegEx
        .Global = True
        .Pattern = Regular_Format
        .IgnoreCase = True
        Bool_IllegalFormat = Not (.test(ProgramName))
    End With
    
    If Bool_IllegalFormat = True Then
        Worksheets("PinMap").Select
        Cells(4, "C") = "Program name illegal!"
    End If
