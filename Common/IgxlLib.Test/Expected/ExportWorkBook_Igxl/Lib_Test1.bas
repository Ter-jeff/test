...
Public Sub TestA()
	...
	rundsp.ConvertToLongAndSerialToParrel InDSPWave, _
	l_DigSrc_Sample_Size, ConvertedDataWf
End Sub

Public Sub TestB()
    Call rundsp.CreateFlexibleDSPWave(InitialDSPWave, DigSrc_Sample_Size, InDSPWave)
	Call rundsp.CreateFlexibleDSPWave(InitialDSPWave, _
	                                  DigSrc_Sample_Size, InDSPWave)
End Sub
	
Public Sub PatternsStart()
    TheHdw.Patterns(dummypat).Start
End Sub

Public Sub PatternsHaltWait()
    TheHdw.Digital.Patgen.HaltWait
End Sub
	
Public Sub PatternsTest()
