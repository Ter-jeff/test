...
{
    internal class GetCp1HvTests(EnumJob enumJob, StreamWriter streamWriter) : SearchLine(enumJob, streamWriter)
    {
        ...
        {
            return binCutLineBase.IsCp2LvStartPoint() || binCutLineBase.Line.Contains("*print: VddBinning_HVCC start*");
        }

        public override bool IsStepStartCs(BinCutLineBase binCutLineBase)
        {
            return binCutLineBase.IsCp2LvStartPointCsharp();
        }

        public override bool IsStopPoint(BinCutLineBase binCutLineBase)
        {
            return binCutLineBase.IsHvStopPoint();
        }
